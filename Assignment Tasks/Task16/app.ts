...
let names : string[]=["Shahzaib","Shaahrozz","Zohaib","Bilal","Sohaib"];
let messages : string[]=["Please join me for Dinner Tonight","Please come over for DInner Tonight","There is a Dinner party tonight, please come","Dinner at my house, please come","please come to my house for lovely Dinner"];
names.push("Shehzad");
