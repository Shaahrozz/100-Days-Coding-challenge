...
let names : string[]=["Shehzad","Shaahrozz","Zohaib","Bilal","Sohaib","shahzaib"];
let messages : string[]=["Please join me for Dinner Tonight","Please come over for DInner Tonight"];
let mess : string="sorry but Dinner is cancelled for tonight, sorry";
